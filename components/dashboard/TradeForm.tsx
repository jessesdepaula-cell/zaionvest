      ...
      <button
        ...
        className={cn(
          ...
          variant === "primary"
            ...
            : "border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.04] text-offwhite hover:bg-[#f5f5f5]/[0.08]",
        )}
      >
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/70 p-4 backdrop-blur-sm">
          <div className="glass relative w-full max-w-lg rounded-xl p-6">
            <button
              ...
              className="absolute right-4 top-4 grid h-7 w-7 place-items-center rounded-md border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.03] text-zinc-300 hover:bg-[#f5f5f5]/[0.06]"
            >
...
function Field({
  ...
  const cls = cn(
    "w-full rounded-md border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.02] px-3 py-2 text-sm text-offwhite outline-none transition focus:border-emerald-500/50 focus:bg-[#f5f5f5]/[0.04]",
  ...
  return (
    <label className="block">
      ...
      <select
        ...
        className="w-full rounded-md border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.02] px-3 py-2 text-sm text-offwhite outline-none transition focus:border-emerald-500/50 focus:bg-[#f5f5f5]/[0.04]"
      >
        {options.map((o) => (
