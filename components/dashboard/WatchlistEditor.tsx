    ...
    <div className="glass rounded-xl p-5">
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-md border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.04] px-3 py-1.5 text-xs text-offwhite hover:bg-[#f5f5f5]/[0.08]"
          >
      ...
      {adding && (
        <form
          ...
          className="mb-3 flex flex-wrap items-end gap-2 rounded-md border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.02] p-3"
        >
          <label className="block">
            ...
            <select
              name="symbol"
              required
              className="rounded-md border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.02] px-2 py-1.5 text-xs outline-none focus:border-emerald-500/50"
            >
              {symbols.map((s) => (
          ...
          <div
            ...
            className={cn(
              ...
              it.active
                ...
                : "border-[#f5f5f5]/5 bg-[#f5f5f5]/[0.01] opacity-50",
            )}
          >
            ...
            <button
              ...
              className="grid h-7 w-7 place-items-center rounded-md text-emerald-400 hover:bg-[#f5f5f5]/[0.04] disabled:opacity-30"
            >
            ...
            <form action={toggleWatch}>
              ...
              <button
                ...
                className={cn(
                  ...
                  it.active
                    ? "text-emerald-400 hover:bg-[#f5f5f5]/[0.04]"
                    : "text-zinc-500 hover:bg-[#f5f5f5]/[0.04] hover:text-zinc-200",
                )}
              >
            ...
            >
              <input type="hidden" name="id" value={it.id} />
              <button className="grid h-7 w-7 place-items-center rounded-md text-zinc-500 hover:bg-[#f5f5f5]/[0.04] hover:text-rose-400">
