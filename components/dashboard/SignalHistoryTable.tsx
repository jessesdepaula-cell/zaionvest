  ...
  return (
    <div>
      ...
      <div className="mb-4 flex flex-wrap gap-2">
        <div className="flex rounded-lg border border-[#f5f5f5]/10 overflow-hidden text-[10px]">
      ...
      {/* Tabela */}
      {paginated.length === 0 ? (
        <div className="rounded-xl border border-[#f5f5f5]/5 bg-[#f5f5f5]/[0.01] py-10 text-center text-sm text-zinc-500">
          Nenhum sinal encontrado para os filtros selecionados.
        </div>
      ) : (
        <div className="overflow-x-auto rounded-xl border border-[#f5f5f5]/5">
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-[#f5f5f5]/5 bg-[#f5f5f5]/[0.02] text-[10px] uppercase tracking-widest text-zinc-500">
            ...
            <tbody>
              {paginated.map((s) => {
                ...
                return (
                  <tr key={s.id} className="border-b border-[#f5f5f5]/[0.03] hover:bg-[#f5f5f5]/[0.015] transition">
                    <td className="px-4 py-3 text-zinc-500">{date}</td>
                    <td className="px-4 py-3 font-semibold text-[#F5F5F5]">{s.symbol}</td>
        ...
        <div className="mt-4 flex items-center justify-between text-xs text-zinc-500">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={page === 0}
              className="flex items-center gap-1 rounded-md border border-[#f5f5f5]/10 px-3 py-1.5 transition hover:bg-[#f5f5f5]/[0.04] disabled:opacity-30"
            >
