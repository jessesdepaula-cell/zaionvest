    ...
    <div className="glass rounded-xl">
      ...
      >
        ...
        <button
          ...
          className="ml-auto grid h-8 w-8 place-items-center rounded-md text-zinc-400 hover:bg-[#f5f5f5]/[0.04] hover:text-offwhite"
        >
      ...
      {expanded && (
        <div className="border-t border-[#f5f5f5]/5 px-4 py-3">
          {trade.notes && (
            <div className="mb-3">
            ...
            <div className="flex flex-wrap items-end gap-3">
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={!!closing}
                  className="inline-flex items-center gap-1.5 rounded-md bg-[#f5f5f5]/[0.04] px-3 py-1.5 text-xs font-medium text-zinc-300 hover:bg-[#f5f5f5]/[0.08] disabled:opacity-50"
                >
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="num w-28 rounded-md border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.02] px-2 py-1.5 text-xs outline-none focus:border-emerald-500/50"
        autoComplete="off"
      />
    </label>
  );
...
function ModePill({ mode }: { mode: string }) {
  return (
    <span className="rounded-md border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.03] px-1.5 py-0.5 text-[9px] uppercase tracking-widest text-zinc-300">
