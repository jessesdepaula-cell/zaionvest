...
export async function TrackRecordSection() {
  ...
  return (
    <section id="resultados" className="relative z-10 mx-auto max-w-6xl px-6 py-24 border-t border-[#f5f5f5]/5">
      {/* Glow decorativo */}
      ...
      <div className="relative">
        ...
        <div className="mb-12 text-center">
          ...
          <h2 className="text-balance text-4xl font-extrabold tracking-tight text-[#F5F5F5] sm:text-5xl">
        ...
        {hasSample ? (
          <>
            ...
            {data.recent.length > 0 && (
              <div className="mt-8 overflow-hidden rounded-2xl border border-[#f5f5f5]/10 bg-gradient-to-b from-[#f5f5f5]/[0.03] to-[#f5f5f5]/[0.01]">
                <div className="flex items-center justify-between gap-3 border-b border-[#f5f5f5]/5 px-5 py-3.5">
                ...
                <div className="divide-y divide-[#f5f5f5]/[0.04]">
                  {data.recent.map((r, i) => {
                    const win = r.status === "WIN";
                    const buy = r.direction?.startsWith("COMPRA");
                    return (
                      <div key={i} className="flex items-center justify-between gap-3 px-5 py-3 text-xs transition hover:bg-[#f5f5f5]/[0.02]">
                        <div className="flex min-w-0 items-center gap-2.5">
                          ...
                          <span className="rounded border border-[#f5f5f5]/10 bg-[#f5f5f5]/[0.02] px-1.5 py-0.5 text-[9px] uppercase tracking-wider text-zinc-400">
        ...
        <div className="mt-10 overflow-hidden rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/[0.10] via-emerald-500/[0.04] to-transparent p-8 text-center sm:p-10">
          ...
          <h3 className="text-balance text-2xl font-extrabold tracking-tight text-[#F5F5F5] sm:text-3xl">
          ...
          <Link
            href="/sign-up"
            className="group mt-6 inline-flex items-center gap-2 rounded-xl border border-emerald-400/40 bg-emerald-500 px-6 py-3.5 text-sm font-bold text-[#000000] shadow-lg shadow-emerald-500/20 transition hover:bg-emerald-400 hover:shadow-emerald-500/40"
          >
...
function ModeCard({ data, label }: { data: ModeTrackRecord; label: string }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[#f5f5f5]/10 bg-gradient-to-br from-[#f5f5f5]/[0.04] to-[#f5f5f5]/[0.01] p-6">
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          <p className="text-[10px] uppercase tracking-widest text-emerald-500 font-semibold">Operacional</p>
          <p className="mt-0.5 text-xl font-bold tracking-tight text-[#F5F5F5]">{label}</p>
        </div>
        {hasData && (
      ...
      {hasData ? (
        <>
          ...
          <div className="mb-5">
            <div className="h-1.5 w-full overflow-hidden rounded-full bg-[#f5f5f5]/5">
              <div
          ...
          <div className="mt-5 flex items-center justify-between gap-3 border-t border-[#f5f5f5]/5 pt-4 text-[11px]">
            <div>
        ...
        <div className="rounded-xl border border-[#f5f5f5]/5 bg-[#f5f5f5]/[0.02] p-4 text-center">
...
function TargetBar({ label, count, pct }: { label: string; count: number; pct: number }) {
  return (
    <div className="flex items-center gap-2.5">
      ...
      <div className="flex-1 h-2 overflow-hidden rounded-full bg-[#f5f5f5]/[0.03]">
        <div
