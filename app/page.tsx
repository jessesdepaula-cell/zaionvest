    ...
    <main className="min-h-screen bg-[#070709] text-zinc-300 selection:bg-emerald-500/30 selection:text-emerald-300 relative overflow-hidden">
      ...
      <header className="relative z-10 mx-auto max-w-6xl flex items-center justify-between px-6 py-6 border-b border-white/5">
        ...
        <nav className="flex items-center gap-4 text-xs">
          ...
          <Link
            href="/sign-up"
            className="rounded-lg border border-white/10 bg-white/[0.04] px-3.5 py-2 text-white transition hover:bg-white/[0.08]"
          >
            Área de Membros
          </Link>
        </nav>
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-6 pt-20 pb-16 text-center">
        ...
        <h1 className="text-balance text-4xl font-extrabold tracking-tight text-white sm:text-7xl">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/sign-up"
            id="cta-hero-primary"
            className="group inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-emerald-500 px-8 py-4 text-sm font-bold text-black shadow-lg shadow-emerald-500/20 transition hover:bg-emerald-400 hover:shadow-emerald-500/30 focus:outline-none"
          >
          ...
          <a
            href="#como-funciona"
            className="text-xs text-zinc-400 hover:text-zinc-200 transition py-4 px-6 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] w-full sm:w-auto text-center"
          >
            Ver como funciona
          </a>
        </div>
      ...
      <section id="como-funciona" className="relative z-10 mx-auto max-w-5xl px-6 py-20 border-t border-white/5">
        ...
        <div className="mt-8 text-center">
          <Link
            href="/sign-up"
            id="cta-trial-flow"
            className="inline-flex items-center gap-2 rounded-xl bg-emerald-500 px-8 py-3.5 text-sm font-bold text-black transition hover:bg-emerald-400"
          >
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-6 py-20 border-t border-white/5">
        ...
        <div className="grid gap-5 sm:grid-cols-3">
          {[
            ...
            <div key={i} className="rounded-2xl border border-white/5 bg-white/[0.015] p-5">
      ...
      <section id="pricing" className="relative z-10 mx-auto max-w-3xl px-6 py-20 border-t border-white/5 text-center">
        <h2 className="text-3xl font-bold tracking-tight text-white">Domine o mercado sem gastar uma fortuna</h2>
        <p className="mt-3 text-sm text-zinc-400 max-w-md mx-auto">
        ...
        <div className="mt-10 mx-auto max-w-sm rounded-3xl border border-emerald-500/20 bg-[#0a0c0b] p-8 shadow-2xl relative overflow-hidden text-left">
          ...
          <div className="mt-4 flex items-baseline gap-1.5">
            <span className="num text-5xl font-extrabold text-white tracking-tight">R$ 47,90</span>
          ...
          <Link
            href="/sign-up"
            id="cta-pricing"
            className="mt-8 w-full flex items-center justify-center gap-2 rounded-xl bg-emerald-500 py-3.5 text-sm font-bold text-black shadow-lg shadow-emerald-500/25 transition hover:bg-emerald-400 hover:shadow-emerald-500/35 focus:outline-none"
          >
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-6 py-20 border-t border-white/5">
        <h2 className="text-center text-xl font-bold tracking-tight text-white flex items-center justify-center gap-2">
      ...
      {/* ─── CTA FINAL ─── */}
      <section className="relative z-10 mx-auto max-w-3xl px-6 py-20 border-t border-white/5 text-center">
        ...
        <Link
          href="/sign-up"
          id="cta-final"
          className="mt-8 inline-flex items-center gap-2 rounded-xl bg-emerald-500 px-10 py-4 text-sm font-bold text-black shadow-lg shadow-emerald-500/25 transition hover:bg-emerald-400"
        >
          Quero meus 3 dias grátis <ArrowRight className="h-4 w-4" />
        </Link>
    ...
    >
      <div
        className={`grid h-9 w-9 place-items-center rounded-lg border ${
          highlight ? "border-emerald-500/20 bg-emerald-500/[0.08]" : "border-white/10 bg-white/[0.02]"
        }`}
      >
        {icon}
      </div>
